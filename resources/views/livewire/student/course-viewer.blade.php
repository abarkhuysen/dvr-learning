            ...
            <div class="flex items-center">
                <div>
                    ...
                    <flux:text size="sm" class="text-gray-600">
                        {{ $userProgress->where('completed', true)->count() }} / {{ $lessons->count() }} lessons
                        completed
                    </flux:text>
                </div>
            </div>
                    ...
                    <div class="flex justify-between items-start mb-4">
                        <div class="flex-1">
                            ...
                            @if($currentLesson->description)
                                <flux:text>{{ $currentLesson->description }}</flux:text>
                            @endif
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                player.on('timeupdate', function (data) {
                    ...
                    if (!hasAutoCompleted && videoDuration > 0) {
                        ...
                        if (watchPercentage >= 90) {
                            ...
                            @this.
                            autoCompleteLesson(lastWatchTime, videoDuration);
                        }
                    }
                });
                ...
                watchTimeUpdateInterval = setInterval(function () {
                    if (lastWatchTime > 0 && videoDuration > 0) {
                        @this.
                        updateWatchTime(lastWatchTime, videoDuration);
                    }
                }, 10000);
